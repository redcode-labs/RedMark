...
static int CmdHFMFPChk(const char *Cmd) {
    ...
    void *argtable[] = {
        ...
        arg_lit0(NULL, "p1", "Check all 1-byte combinations of key (0000...0000, 0101...0101, 0202...0202, ...)"),
        arg_lit0(NULL, "p2", "Check all 2-byte combinations of key (0000...0000, 0001...0001, 0002...0002, ...)"),
        arg_str0(NULL, "p2s",  "<pattern>", "Start key (2-byte HEX) for 2-byte search (use with `--pattern2b`)"),
    ...
    uint8_t endSector = arg_get_int_def(ctx, 4, 255);
