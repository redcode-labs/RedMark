...
static command_t CommandTable[] = {
    ...
    {"--------",     CmdHelp,      AlwaysAvailable,         "----------------------- " _MAGENTA_("Technology") " -----------------------"},
    {"a",      CmdAnalyse,   AlwaysAvailable,         "[ Analyse utils... ]"},
    {"d",         CmdData,      AlwaysAvailable,         "[ Plot window / data buffer manipulation... ]"},
    ...
    {"rvng",       CmdRev,       AlwaysAvailable,         "[ CRC calculations from RevEng software... ]"},
    {"smart",        CmdSmartcard, AlwaysAvailable,         "[ Smart card ISO-7816 commands... ]"},
    {"x",            CmdScript,    AlwaysAvailable,         "[ Scripting commands... ]"},
    //{"r",            CmdScriptRun, AlwaysAvailable,      "[ Runner commands... ]"},
    {"t",        CmdTrace,     AlwaysAvailable,         "[ Trace manipulation... ]"},
    {"usart",        CmdUsart,     IfPm3FpcUsartFromUsb,    "[ USART commands... ]"},
    {"wiegand",      CmdWiegand,   AlwaysAvailable,         "[ Wiegand format manipulation... ]"},
    {"--------",     CmdHelp,      AlwaysAvailable,         "----------------------- " _MAGENTA_("General") " -----------------------"},
    ...
    {"s",            CmdMsleep,    AlwaysAvailable,         "[ Add a pause in milliseconds ]"},
    {"rem",          CmdRem,       AlwaysAvailable,         "[ Add a text line in log file ]"},
    {"piv",          CmdPIV,       AlwaysAvailable,         "[ PIV commands... ]"},
    {"help",         CmdHelp,      AlwaysAvailable,         "[ Show help menu ]"},
