...
#ifndef LIBPM3
#define BANNERMSG1 ""
#define BANNERMSG2 "[ Wintrmvte " _RED_("<*>") " ]"
#define BANNERMSG3 ""
...
static void showBanner_logo(LogoMode mode) {
    ...
    PrintAndLogEx(NORMAL, _MAGENTA_("888 88e       e   e         III   III   III   "));
    PrintAndLogEx(NORMAL, _MAGENTA_("888  88D     d8b d8b        III   III   III   "));
    PrintAndLogEx(NORMAL, _MAGENTA_("888 888     e Y8b Y8b       III   III   III   "));
    PrintAndLogEx(NORMAL, _MAGENTA_("888        d8b  👾 Y8b      III   III   III   ") BANNERMSG1);
    PrintAndLogEx(NORMAL, _MAGENTA_("888       d88       Y8b     III   III   III   ") BANNERMSG2);
