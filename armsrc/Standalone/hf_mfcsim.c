 ...
 * Data is read from bin dump file uploaded to flash memory (xx.bin).
 * Only support mifare classic 1k
 *
 * To upload input file (eml format) to flash:
 * - mem spiffs upload -s <filename> -d mfc_xx.bin (Notes: xx is form 01 to 15)
...
#define HF_MFCSIM_DUMPFILE_SIM "mfc_%02d.bin"
