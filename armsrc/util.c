...
int BUTTON_WAIT(void){
    for (;;) {
        ...
        WDT_HIT();
        int button_pressed = BUTTON_CLICKED(MAX_MS);
        if ((button_pressed == BUTTON_HOLD) || (button_pressed == BUTTON_SINGLE_CLICK) || (button_pressed == BUTTON_DOUBLE_CLICK)) {
